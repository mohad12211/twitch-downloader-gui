...
uiControl *VodDownloaderDrawUi() {
  ...
  *vodOptions = (VodOptions){
      linkEntry,     nameLabel,    titleLabel,  durationLabel, createdLabel, logsEntry, pBar,     status,  downloadBtn, infoBtn, NULL,  NULL,           0,         cropStartCheck, cropEndCheck,
      startSpinsBox, cropStartBox, endSpinsBox, cropEndBox,    startHour,    startMin,  startSec, endHour, endMin,      endSec,  OAuth, dwnThreadsSpin, imageArea, handler,
  };
