...
static int getId(const char *link, char **id);
...
uiControl *ChatDownloaderDrawUi() {
  ...
  *chatOptions = (ChatDwnOptions){
      linkEntry,    nameLabel,     titleLabel,   durationLabel, createdLabel, logsEntry, pBar,     status,   downloadBtn, infoBtn, NULL,   NULL,        downloadFormats, timeFormats, cropStartCheck,
      cropEndCheck, startSpinsBox, cropStartBox, endSpinsBox,   cropEndBox,   startHour, startMin, startSec, endHour,     endMin,  endSec, embedEmotes, imageArea,       handler,
  };
